        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 mb-6">
              This privacy policy is currently being updated. Please check back soon for our complete privacy policy that outlines how EPOS Payments collects, uses, and protects your personal information.
            </p>
            <p className="text-gray-600 mb-6">
              If you have any questions about our privacy practices, please contact us at{" "}
              <a href="mailto:privacy@epos.com" className="text-cyan-500 hover:text-cyan-400">
                privacy@epos.com
              </a>
            </p>
          </div>
